...
import 'package:flutter/material.dart';
import 'package:game_rpg/Features/Lobby/presentation/characterSelection.dart'; // Đảm bảo tên file đúng
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.dark(), // Dùng theme tối
      home: CharacterSelectionScreen(), // Chạy màn hình chọn nhân vật
    );
  }
}