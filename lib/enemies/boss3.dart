...
class Boss3 extends BossEntity {
  Boss3(Vector2 position)
      : super(
          ...
          animation:
              EnemySpriteSheet.boss3Animations(), // Sprite sheet cho DarkBoss
          attack: 40,
        );
  ...
  void _showConversation() {
    ...
    TalkDialog.show(
      ...
      [
        Say(
          text: [TextSpan(text: getString('talk_kid_9'))],
        ...
        Say(
          text: [TextSpan(text: getString('talk_boss3_1'))],
          person: CustomSpriteAnimationWidget(
            animation:
                EnemySpriteSheet.boss3IdleRight(), // Dùng sprite của DarkBoss
          ),
          personSayDirection: PersonSayDirection.LEFT,
        ),
        Say(
          text: [TextSpan(text: getString('talk_player_9'))],
          person: CustomSpriteAnimationWidget(
        ...
        Say(
          text: [TextSpan(text: getString('talk_boss3_2'))],
          person: CustomSpriteAnimationWidget(
            animation:
                EnemySpriteSheet.boss3IdleRight(), // Dùng sprite của DarkBoss
          ),
