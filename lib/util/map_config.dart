...
import 'package:game_rpg/enemies/boss3.dart';
...
// note boss2, orc, orc_shaman khi xuất hiện thì lỗi rất nhiều
class MapConfig {
  static final List<Map<String, dynamic>> maps = [
    ...
    // },
    // {
    //   'path': 'tiled/old_version/island.json',
    //   'bossBuilder': (Vector2 p) => Boss1(p),
  ...
  static WorldMapByTiled? getMap(int index) {
    ...
    final Map<String, GameComponent Function(TiledObjectProperties)>
      ...
      'empty_torch': (p) => Torch(p.position, empty: true),
